...
<head>
    ...
    <title>Create Room Listing</title>
            ...
            <div class="col-lg-9">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">Create Room Listing</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" class="form-control" rows="3"
                                              placeholder="Describe your apartment or room..."></textarea>
                                </div>

                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="rent" class="form-label">Monthly Rent ($)</label>
                                        <input name="rent" type="number" class="form-control" id="rent" required min="0">
                                    </div>

                                    <div class="col-md-6 mb-3">
                                        <label for="utilitiesCost" class="form-label">Utilities Cost ($)</label>
                                        <input name="utilitiesCost" type="number" class="form-control" id="utilitiesCost" min="0" value="0">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="squareFeet" type="number" class="form-control" id="squareFeet" min="0">
                                </div>

                                <!-- Available Until Field -->
                                <div class="mb-3">
                                    <label for="availableUntil" class="form-label">Available Until (Optional)</label>
                                    <input type="date" id="availableUntil" name="availableUntil" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="transportOptions" type="text" class="form-control" id="transportOptions"
                                           placeholder="Public transit, parking, etc.">
                                </div>

                                <!-- Nearby Universities Field -->
                                <div class="mb-3">
                                    ...
                                    <input name="nearbyUniversities" type="text" class="form-control" id="nearbyUniversities"
                                           placeholder="List nearby universities/colleges">
                                </div>

                                <!-- Distance to University Field -->
                                <div class="mb-3">
                                    <label for="distanceToUniversity" class="form-label">Distance to University (in minutes)</label>
                                    <input name="distanceToUniversity" type="number" class="form-control" id="distanceToUniversity" min="0">
                                </div>
                            </div>
                            ...
                            <div class="form-section">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="numBeds" type="number" class="form-control" id="numBeds" required min="1" value="1">
                                    </div>

                                    <div class="col-md-4 mb-3">
                                        <label for="currentOccupancy" class="form-label">Current Occupancy</label>
                                        <input name="currentOccupancy" type="number" class="form-control" id="currentOccupancy" required min="0" value="0">
                                    </div>

                                    <div class="col-md-4 mb-3">
                                        <label for="totalCapacity" class="form-label">Total Capacity</label>
                                        <input name="totalCapacity" type="number" class="form-control" id="totalCapacity" required min="1" value="1">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="numBaths" type="number" class="form-control" id="numBaths" step="0.5" min="0">
                                    <div class="form-text">Use 0.5 for half-bathrooms</div>
                                </div>

                                <div class="mb-3">
                                    <label for="availableFrom" class="form-label">Available From</label>
                                    <input type="date" id="availableFrom" name="availableFrom" class="form-control" required value="${today}">
                                </div>

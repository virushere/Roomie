...
//        }
//
//        // Add the user's roommate listing (the user profile itself)
...
//        }
//
//        // Get the user's room listings from the database
...
//
//        // Important: Use email for preference lookup to match DB
//        List<UserPreferences> preferences = userPreferencesService.getPreferencesByUserId(email);
//        System.out.println("Found " + preferences.size() + " preferences for user " + email);

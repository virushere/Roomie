...
//import com.roomatefinder.demo.repositories.MessageRepository;
...
//        List<Message> messages = messageRepository.findBySenderIdAndRecipientIdOrRecipientIdAndSenderIdOrderBySentAtDesc(
...
//        return messageRepository.findByRecipientIdAndReadFalse(userId).size();
//    }
//}
